...
public class HadoopOfficeReadConfiguration implements Serializable {
	 ...
	 *            <li> hadoopoffice.read.linkedworkbooks.location (as of 1.2.3): location of linked workbooks (only one folder). If set to empty String then the same folder as the main excel file is used. Default: set to empty String</li>
