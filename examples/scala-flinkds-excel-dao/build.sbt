...
libraryDependencies += "com.github.zuinnote" % "hadoopoffice-fileformat" % "1.3.3" % "compile"

libraryDependencies += "com.github.zuinnote" % "hadoopoffice-flinkds" % "1.3.3" % "compile"
