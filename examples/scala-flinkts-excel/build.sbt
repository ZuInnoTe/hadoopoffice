...
libraryDependencies += "com.github.zuinnote" %% "hadoopoffice-flinkts" % "1.3.8" % "compile"
...
libraryDependencies += "org.apache.flink" % "flink-table" % "1.9.2" % "provided" 

libraryDependencies += "org.apache.flink" % "flink-table-common" % "1.9.2" % "provided" 

libraryDependencies += "org.apache.flink" %% "flink-table-planner" % "1.9.2" % "provided" 
libraryDependencies += "org.apache.flink" %% "flink-table-api-java-bridge" % "1.9.2" % "provided" 
libraryDependencies += "org.apache.flink" %% "flink-table-api-scala-bridge" % "1.9.2" % "provided" 
// needed for table environment 
libraryDependencies += "org.apache.flink" %% "flink-streaming-scala" % "1.9.2" % "provided" 

// needed for writable serializer 
libraryDependencies += "org.apache.flink" %% "flink-hadoop-compatibility" % "1.9.2" % "provided" 
